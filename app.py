###############################################################################
# FitBites – full app (2025-05-13)  with pairing rules + plan-based recipes
###############################################################################
...
def gpt_plan(prefs,dislikes,kcal):
    ...
    rules=("Pairings:\n"
           "• Hausa koko/koko **must** go with bofrot **or** bread & groundnuts\n"
           "• Fufu goes with **any soup except okro**; no stews; may include chicken, snails or crabs\n"
           "• Banku goes with okro soup + any protein\n")
